...
namespace StudioDrydock.AppStoreConnect.Cli.Models
{
    public class GameCenterAchievementLocalization
    {
        ...
        internal void UpdateWithResponse(AppStoreClient.GameCenterAchievementLocalization data)
        {
			this.id = data.id;
			this.locale = data.attributes.locale;
			this.name = data.attributes.name;
		...
		internal AppStoreClient.GameCenterAchievementLocalizationCreateRequest CreateCreateRequest(string achievementId)
		{
			return new()
			{
				data = new()
		...
		internal AppStoreClient.GameCenterAchievementLocalizationUpdateRequest CreateUpdateRequest()
		{
			return new()
			{
				data = new()
